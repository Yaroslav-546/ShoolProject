...
from .validators import validate_grade_contains, validate_russian_name, validate_capital_first_letter, validate_special_characters, validate_no_spaces
...
class CustomUser(AbstractUser):
    first_name = models.CharField(
        ...
        max_length=150,
        validators=[
            validate_russian_name,
            validate_special_characters,
            validate_capital_first_letter,
            validate_no_spaces
        ]
    )
